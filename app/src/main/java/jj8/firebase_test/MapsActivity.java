...
//This class implements the turn-by-turn navigation feature when the user clicks on any event on the event schedule.
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
   ...
   @Override
    public void onMapReady(GoogleMap googleMap) {
        ...
        // Add a marker in Portland and move the camera
